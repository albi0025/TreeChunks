...
import { Panel, Button, Glyphicon, Badge, Thumbnail } from 'react-bootstrap';
...
class DashboardTree extends React.Component {
  ...
  render() {
    ...
    let cover="";
    {
      ...
      ? cover = this.props.tree.cover
      : cover = "/images/coverlogo.png";
    }
...
export default inject("userStore")(observer(DashboardTree));
